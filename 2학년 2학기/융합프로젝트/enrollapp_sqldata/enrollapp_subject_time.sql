...
CREATE TABLE `subject_time` (
  `subject_time_id` int NOT NULL AUTO_INCREMENT,
  `subjectOpen_subject_id` int NOT NULL,
  `day` varchar(10) DEFAULT NULL,
  `time` varchar(10) DEFAULT NULL,
  `classroom` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`subject_time_id`),
  KEY `fk_subjectTime_SubjectOpen1_idx` (`subjectOpen_subject_id`)
...
INSERT INTO `subject_time` VALUES (11,1000,'월','34','D329'),(12,2100,'수','34','D330'),(13,2200,'목','67','D330');
